...
class UserController extends Controller
{
    ...
    public function index()
    {
       ...
       // echo "Bonjour tout le monde!!";
        return view('National/Users/index')->with(compact('users'));
    ...
    public function create()
    {
        ...
        $roles = Role::all();
        $pays = Pay::all();
        return view('National/Users/create')->with(compact('roles','pays'));
    }
    ...
    public function show(User $user)
    {
        ...
        return view('National/Users/show')->with(compact('user'));
    }
