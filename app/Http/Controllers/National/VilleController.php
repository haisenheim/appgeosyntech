...
class VilleController extends Controller
{
    ...
    public function index(Request $request)
    {
       ...
       // $request->session()->flash('message','Liste des villes!!!');
        return view('National/Villes/index')->with(compact('villes','pays'))->with('success','Liste des villes');
    ...
    public function create()
    {
        //
        $pays = Pay::all();
        return view('National/Villes/create')->with(compact('pays'));
    }
    ...
    public function show(Ville $ville)
    {
        ...
        return view('National/Villes/show')->with(compact('ville'));
    }
