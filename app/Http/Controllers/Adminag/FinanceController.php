...
class FinanceController extends Controller
{
    ...
    public function getCreancesApporteur($token)
    {
	    ...
	    return view('Adminag/Commercials/creances')->with(compact('factures','apporteur'));
    }
	...
	public function getPayeesApporteur($token)
	{
		...
		return view('Adminag/Commercials/payees')->with(compact('factures','apporteur'));
	}

	public function showFactureApporteur( $token)
	{
		$facture = Facture::where('token',$token)->first();
		return view('Adminag/Commercials/facture')->with(compact('facture'));
		//
	}
	...
	public function fillFacture(Request $request, $token)
	{
		...
		if($facture->alliages){
			$pdf = PDF::loadView('Adminag/Alliages/recu',$data);
		}else{
			$pdf = PDF::loadView('Adminag/Commercials/recu',$data);
		}
	...
	public function getCreancesConsultant($token)
    {
	    ...
	    return view('Adminag/Experts/creances')->with(compact('factures','apporteur'));
    }
	...
	public function getPayeesConsultant($token)
	{
		...
		return view('Adminag/Experts/payees')->with(compact('factures','apporteur'));
	}

	public function showFactureConsultant( $token)
	{
		$facture = Facture::where('token',$token)->first();
		return view('Adminag/Experts/facture')->with(compact('facture'));
		//
	}
	...
	public function getCreancesAlliages()
	{
		...
		return view('Adminag/Alliages/creances')->with(compact('factures'));
	}
	...
	public function getPayeesAlliages()
	{
		...
		return view('Adminag/Alliages/payees')->with(compact('factures'));
	}

	public function showFactureAlliages( $token)
	{
		$facture = Facture::where('token',$token)->first();
		return view('Adminag/Alliages/facture')->with(compact('facture'));
		//
	}
	...
	public function getPerformance(){
		...
		return view('Adminag/Finances/performance')->with(compact('paiements'));
	}
