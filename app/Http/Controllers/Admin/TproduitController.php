...
class TproduitController extends Controller
{
    ...
    {
	    $categories = Tproduit::all();
	    return view('Admin/Tproduits/index')->with(compact('categories'));
    }
	...
	public function store(Request $request)
	{
		...
		$ville = Tproduit::create($ville);

		$request->session()->flash('success','Le type a été correctement enregistré !!!');
		return back();
