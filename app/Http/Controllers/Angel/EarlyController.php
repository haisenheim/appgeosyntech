...
class EarlyController extends Controller
{
	...
	public function createDiagExterne($token){
		...
		return view('/Angel/Earlies/create_diag_externe')->with(compact('projet'));
	}
	...
	public function createDiagStrategique($token){
		$projet = Earlie::where('token',$token)->first();
		return view('/Angel/Earlies/create_diag_strategique')->with(compact('projet'));
	}
	...
	public function createPlanFinancier($token){
		...
		$moyens = Moyen::all();
		$projet = Earlie::where('token',$token)->first();
		return view('/Angel/Earlies/create_plan_financier')->with(compact('projet','moyens'));
	}
	...
	public function show($token)
	{
		...
		return view('/Angel/Earlies/show')->with(compact('projet','modes'));
	}
