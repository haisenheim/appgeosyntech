...
class InfrastructureController extends Controller
{
	...
	public function createDiagExterne($token){
		...
		return view('/Angel/Infrastructures/create_diag_externe')->with(compact('projet'));
	}
	...
	public function createDiagStrategique($token){
		$projet = Infrastructure::where('token',$token)->first();
		return view('/Angel/Infrastructures/create_diag_strategique')->with(compact('projet'));
	}
	...
	public function createPlanFinancier($token){
		...
		$moyens = Moyen::all();
		$projet = Infrastructure::where('token',$token)->first();
		return view('/Angel/Infrastructures/create_plan_financier')->with(compact('projet','moyens'));
	}
	...
	public function show($token)
	{
		...
		return view('/Angel/Infrastructures/show')->with(compact('projet','mois'));
	}
