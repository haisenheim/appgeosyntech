...
class CentreController extends Controller
{
    ...
    {
	    $centres = Centre::all()->where('creator_id',Auth::user()->id);
	    //$pays = Pay::all();
	    return view('Consultant/Centres/index')->with(compact('centres'));
    }
    ...
    public function show($token)
    {
	    ...
	    return view('Consultant/Centres/show')->with(compact('centre'));
    }
