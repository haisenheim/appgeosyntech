...
class FactureController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Consultant/Factures/index')->with(compact('factures'));
	...
	public function creances()
	{
		...
		return view('Consultant/Factures/creances')->with(compact('factures'));
	}
	...
	public function payees()
	{
		...
		return view('Consultant/Factures/payees')->with(compact('factures'));
    ...
    public function show( $token)
    {
	    ...
	    return view('Consultant/Factures/show')->with(compact('facture'));
        //
    }
	...
	public function printit( $token)
	{
		...
		$pdf = PDF::loadView('Consultant/Factures/print',$data);
