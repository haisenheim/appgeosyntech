...
class EntrepriseController extends Controller
{
    ...
    {
	    $entreprises = Entreprise::all()->where('creator_id',Auth::user()->id);
	    //$pays = Pay::all();
	    return view('Consultant/Entreprises/index')->with(compact('entreprises'));
    }
	...
	public function show($token)
	{
		...
		return view('Consultant/Entreprises/show')->with(compact('entreprise'));
	}
