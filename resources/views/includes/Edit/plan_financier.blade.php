...
<script type="text/javascript">
  ...
  $('#mfinancements input').click(function(){

      var checked_input = $('#mfinancements input:checked');
      var found = false;
      ...
      if($(this).data('id')==1){
              if($(this).is(":checked")){
                  $('#capital').show();
                  $('#cel-1').prop('contenteditable',true).css({
      ...
      if($(this).data('id')==2){
          if($(this).is(":checked")){
              ...
              $('#cel-2').prop('contenteditable',true).css({
                  background:'#c4ffc4', 'text-align':'right', 'padding-right':'5px'
              });
          }else{
      ...
      if($(this).data('id')==3){
          if($(this).is(":checked")){
              $('#emp_oblig').show();
              $('#cel-3').prop('contenteditable',true).css({
                  background:'#c4ffc4', 'text-align':'right', 'padding-right':'5px'
              });
          }else{
              $('#emp_oblig').hide();
      ...
      if($(this).data('id')==4){
          if($(this).is(":checked")){
              $('#mlt').show();
              $('#cel-4').prop('contenteditable',true).css({
                  background:'#c4ffc4', 'text-align':'right', 'padding-right':'5px'
              });
          }else{
              $('#mlt').hide();
      ...
      if($(this).data('id')==5){
          if($(this).is(":checked")){
              $('#credbail').show();
              $('#cel-5').prop('contenteditable',true).css({
                  background:'#c4ffc4', 'text-align':'right', 'padding-right':'5px'
              });
          }else{
              $('#credbail').hide();
      ...
      if($(this).data('id')==7){
          if($(this).is(":checked")){
              $('#escompte').show();
              $('#cel-7').prop('contenteditable',true).css({
                  background:'#c4ffc4', 'text-align':'right', 'padding-right':'5px'
              });
          }else{
              $('#escompte').hide();
      ...
      if($(this).data('id')==9){
          if($(this).is(":checked")){
              $('#affacturage').show();
              $('#cel-9').prop('contenteditable',true).css({
                  background:'#c4ffc4', 'text-align':'right', 'padding-right':'5px'
              });
          }else{
              $('#affacturage').hide();
      ...
      if($(this).data('id')==10){
          if($(this).is(":checked")){
              $('#billet_treso').show();
              $('#cel-10').prop('contenteditable',true).css({
                  background:'#c4ffc4', 'text-align':'right', 'padding-right':'5px'
              });
          }else{
              $('#billet_treso').hide();
