    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/consultant/planning" class="nav-link {{ $active==3?'active':'' }}">
          ...
          <li  class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="/consultant/members" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="/consultant/entreprises" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>CLIENTS CORPORATE</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="/consultant/centres" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
           ...
           <li class="nav-item">
            <a href="/consultant/mailbox" class="nav-link {{ $active==5?'active':'' }}">
          ...
          <li class="nav-item">
            <a href="/consultant/chaire" class="nav-link {{ $active==2?'active':'' }}">
