                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a class="dropdown-item" href="#"><i class="mdi mdi-credit-card-outline font-size-16 align-middle mr-1"></i> Contacter l'rhistrateur</a>
                ...
                <div data-simplebar class="h-100">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="/rh/dashboard" class="waves-effect">
                            ...
                            <li>
                                <a href="/rh/users" class="waves-effect">
                            ...
                            <li>
                                <a href="/rh/salaires" class="waves-effect">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="/rh/secteurs">SECTEURS</a></li>
                                    <li><a href="/rh/competences">COMPETENCES</a></li>
                                    <li><a href="/rh/postes">POSTES</a></li>
                                    <li><a href="/rh/tcontrats">TYPES DE CONTRAT</a></li>
