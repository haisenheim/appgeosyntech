                    ...
                    @foreach($users as $ville)
                          <tr>
                              ...
                              <ul style="margin-bottom: 0" class="list-inline">
                                <li class="list-inline-item"><a class="btn btn-default btn-xs" href="{{route('national.porteurs.show',[$ville->id])}}"><i class="fa fa-search"></i></a></li>
                              </ul>
                              </td>
                          </tr>
                      @endforeach
                  ...
                  <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form enctype="multipart/form-data" role="form" action="{{route('national.porteurs.store')}}" method="post">
                        {{csrf_field()}}
                          <div class="card-body">
