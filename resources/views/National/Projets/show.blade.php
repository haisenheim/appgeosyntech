            ...
            <div class="col-12 col-md-12 col-lg-3 order-1 order-md-2">
              ...
              <div class="text-muted">
                ...
                <p class="text-sm">Consultant
                   ...
                   @else
                                <form class="form-inline"  action="/national/dossier/expert">
                                {{csrf_field()}}
    ...
    <nav class="floating-menu">
        <ul class="main-menu">
            ...
            @if($projet->etape==1 && $projet->validated_step==0 )
                   <li>
                        <a  title="Valider le premier paiement" class="ripple" href="/national/dossier/validate-diag-interne/{{ $projet->token }}"><i class="fa fa-coins"></i></a>
                   </li>
            @endif
            @if($projet->etape==2 && $projet->validated_step<2 )
                   <li>
                        <a  title="Valider le deuxieme paiement" class="ripple" href="/national/dossier/validate-diag-externe/{{ $projet->token }}"><i class="fa fa-coins"></i></a>
                   </li>
            @endif
            @if($projet->etape==3 && $projet->validated_step<3 )
                   <li>
                        <a  title="Valider le troisieme paiement" class="ripple" href="/national/dossier/validate-plan-strategique/{{ $projet->token }}"><i class="fa fa-coins"></i></a>
                   </li>
            @endif
            @if($projet->etape==4 && $projet->validated_step<4 )
                   <li>
                        <a  title="Valider le quatrieme paiement" class="ripple" href="/national/dossier/validate-plan-financier/{{ $projet->token }}"><i class="fa fa-coins"></i></a>
                   </li>
            @endif
             ...
             @if($projet->etape==4 && $projet->validated_step>=4 )
                @if($projet->ordrevirement_validated)
                   <li>
                        <a  title="Rejeter l'ordre de virement" class="ripple" href="/national/dossier/disvalidate-ordre-virement/{{ $projet->token }}"><i class="fa fa-trash"></i></a>
                   </li>
                 @else
                   <li>
                        <a  title="Valider l'ordre de virement" class="ripple" href="/national/dossier/validate-ordre-virement/{{ $projet->token }}"><i class="fa fa-check"></i></a>
                   </li>
                 @endif
            @endif
            ...
            @if($projet->active )
                   <li>
                        <a  title="Bloquer le dossier" class="ripple" href="/national/dossier/disable/{{ $projet->token }}"><i class="fa fa-lock"></i></a>
                   </li>
             @else
                    <li>
                        <a  title="debloquer le dossier" class="ripple" href="/national/dossier/enable/{{ $projet->token }}"><i class="fa fa-unlock"></i></a>
                   </li>
            @endif
                                                ...
                                                <div class="dropdown-menu" role="menu">
                                                 <?php if($invest->lettre): ?>
                                                    ...
                                                    @if($invest->doc_juridiqueUri)
                                                         <a class="dropdown-item" href="/national/investissement/doc/display/{{ $invest->token }}">Voir le document juridique</a>
                                                        @if($invest->obac_doc_juridique_validated)
                                                            <a class="dropdown-item" href="/national/investissement/doc/reject/{{ $invest->token }}">Rejeter le document juridique</a>
                                                            @if($invest->justificatifUri)
                                                                <a class="dropdown-item" href="/national/investissement/justificatif/display/{{ $invest->token }}">Voir le justificatif de paiement</a>
                                                                @if($invest->obac_justificatif_validated)
                                                                    <a class="dropdown-item" href="/national/investissement/justificatif/reject/{{ $invest->token }}">Rejeter le justificatif de paiement</a>
                                                                @else
                                                                    <a class="dropdown-item" href="/national/investissement/justificatif/validate/{{ $invest->token }}">Valider le justificatif de paiement</a>
                                                                @endif
                                                            @endif
                                                        @else
                                                             <a class="dropdown-item" href="/national/investissement/doc/validate/{{ $invest->token }}">Valider le document juridique</a>
                                                        @endif
                                                    @endif
                                                  <?php endif; ?>
                                                  @if($invest->obac_doc_juridique_validated)
                                                      <?php if(!$invest->doc_juridique): ?>
                                                        <a title="Autoriser l'accès à la documentation juridique" class="dropdown-item" href="/national/dossier/docs/open/{{ $invest->token }}">Ouvrir la documentation</a>
                                                      <?php else: ?>
                                                        <a title="Autoriser l'accès à la documentation juridique" class="dropdown-item" href="/national/dossier/docs/close/{{ $invest->token }}">Fermer la documentation</a>
                                                      <?php endif; ?>
