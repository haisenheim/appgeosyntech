    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 style="color: orange" class="mb-0 font-size-18">{{$projet->client->sigle }} <span>PROFORMA DU </span> <span>{{ date_format($projet->created_at,'d/m/Y') }}</span></h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">GSM</a></li>
                        <li class="breadcrumb-item active">{{ $projet->client?$projet->client->name:'-' }}</li>
                    </ol>
                </div>
                ...
                <div class="card-header">
                    <ul class="list-inline pull-right">
                        <li class="list-inline-item">
                            <a href="/proforma/print/{{ $projet->token }}" title="imprimer" class="btn tbn-xs btn-danger"><i class="mdi mdi-printer"></i></a>
                        </li>
                    </ul>
                </div>
                <div class="card-body">
                                            ...
                                            @if($projet->lignes->count())
                                                @foreach($projet->lignes as $prdt)
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td><a class="badge badge-danger" href="/admin/proforma/remove-produit/{{$prdt->id}}"><i class="fa fa-trash"></i></a></td>
                                                    </tr>
                                                    <?php $som=$som+$aux; ?>
                                                @endforeach
                                                <tr>
               ...
               <div class="modal-dialog">
                 <div class="modal-content">
                   ...
                   <div class="modal-body">
                     <form enctype="multipart/form-data" role="form" action="/admin/proforma/add-produit" method="post">
                     {{csrf_field()}}
                     <input type="hidden" name="proforma_id" value="{{ $projet->id }}"/>
