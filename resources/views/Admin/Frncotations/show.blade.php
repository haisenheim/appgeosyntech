                ...
                <div class="card-body">
                     ...
                     <div class="row">
                        <div class="col-md-5 col-sm-12">
                            <div style="border: 1px solid #7c8a96;" class="card">
                                <div class="card-header bg-secondary">
                                    <h6 style="font-weight: bolder" class=" text-white">B- INFORMATIONS COMPLEMENTAIRES</h6>
                                </div>
                                <div class="card-body">
                                    <P>
               ...
               <div class="modal-dialog">
                 <div class="modal-content">
                   ...
                   <div class="modal-body">
                     <form enctype="multipart/form-data" role="form" action="/admin/frncotation/add-produit" method="post">
                     {{csrf_field()}}
                     <input type="hidden" name="frncotation_id" value="{{ $projet->id }}"/>
