...
@section('page-title')
    <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3 class="m-0 text-dark">BONS DE COMMANDE FOURNISSEUR</h3>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">BONS DE COMMANDE <a class="btn btn-orange btn-xs pull-right" href="#" data-toggle="modal" data-target="#modal-lg"><i class="fa fa-plus-circle"></i></a></h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-hover table-condensed datatable">
                    ...
                    @foreach($cotations as $projet)
                          ...
                          <tr>
                              ...
                              <td>{{ number_format($projet->gross_volume,2,',','.') }}</td>
                              <td>{{ number_format($projet->goss_weigth,2,',','.') }} kg</td>
                               <td>{{ number_format($projet->montant,2,',','.') }} €</td>
                  ...
                  <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form enctype="multipart/form-data" role="form" action="{{route('admin.forders.store')}}" method="post">
                        {{csrf_field()}}
                          <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                      <label for="pay_id">PROJET</label>
                                      <select name="projet_id" id="pay_id" class="form-control">
                                        <option value="0">SELECTIONNER </option>
                                            @foreach($projets as $proj)
                                                <option value="{{ $proj->id }}">{{ $proj->client->sigle .'-'.$proj->site.'-'. \Illuminate\Support\Str::limit($proj->name,30) }}</option>
                                            @endforeach
                                      </select>
                                    </div>
                                </div>
