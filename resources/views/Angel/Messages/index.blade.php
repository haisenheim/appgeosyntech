            ...
            <div class="card-body p-0">
              ...
              <div class="table-responsive mailbox-messages">
                <table id="table-mgs" class="table table-hover table-striped">
                  ...
                  <?php $prefx = '';
                    if($reception->investissement){
                        $prefx=$reception->investissement->projet->name;
                    }
                    if($reception->cession){
                        $prefx=$reception->cession->actif->name;
                    }
                    if($reception->concession){
                        $prefx=$reception->concession->infrastructure->name;
                    }
                   ?>
   ...
   <div class="modal-dialog modal-lg">
     <div class="modal-content">
       ...
       <div class="modal-body">
         <form enctype="multipart/form-data" role="form" action="{{route('angel.mailbox.store')}}" method="post">
         {{csrf_field()}}
