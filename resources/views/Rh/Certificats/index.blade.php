            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">CERTIFICATS ET AUTRES DOCUMENTS </h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                          ...
                          <tr style="background-color: <?= $certificat->expired?'red':'' ?>">
                              ...
                              <td>{{ $certificat->tcertificat?$certificat->tcertificat->name:'-' }} </td>
                               <td>{{ $certificat->user?$certificat->user->name:'-' }} </td>
                                ...
                                @if($certificat->ante)
                                    <td> <a href="{{route('rh.certificats.show',[$certificat->ante->token])}}">{{ $certificat->ante->name }}</a></td>
                                @else
                                    <td>AUCUN</td>
                                @endif
                              ...
                              <ul style="margin-bottom: 0" class="list-inline">
                                <li class="list-inline-item"><a class="btn btn-default btn-xs" href="{{route('rh.certificats.show',[$certificat->token])}}"><i class="fa fa-eye"></i></a></li>
