        ...
        <div class="col-md-8 col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h4>COMPETENCES <a href="#" data-toggle="modal" data-target="#addCompetence" class="btn btn-xs btn-info pull-right"><i class="fa fa-plus-ciacle"></i></a></h4>
                </div>
                <div class="card-body">
                    ...
                    <div class="tab-content p-3">
                        ...
                        <div class="tab-pane" id="messages-justify" role="tabpanel">
                            <p class="mb-0">
                                ...
                                single-origin coffee squid. Exeacitation +1 labore velit, blog
            ...
            <div class="card card-info">
                ...
                <div class="card-body">
                        <div style="padding: 10px auto">
                            <div class="">
                              <img style="max-height: 100px; max-height:100px; border-radius: 50%" sac="<?= $user->imageUri?asset('img/'. $user->imageUri):asset('img/avatar.png') ?>" class="img-ciacle elevation-2">
                            </div>
                        </div>
