          ...
          <div class="card">
            ...
            <div class="card-body p-0">
              <ul class="nav nav-pills flex-column">
                ...
                <li class="nav-item">
                  <a href="{{ route('consultant.mailbox.sent') }}" class="nav-link">
              ...
              <div class="table-responsive mailbox-messages">
                <table id="table-mgs" class="table table-hover table-striped">
                  ...
                  <tr>
                    ...
                    <td style="font-weight: {{ $reception->lu?100:800 }}" class="mailbox-name"><a href="/consultant/mailbox/{{ $reception->token }}">{{ $reception->expediteur->name }}</a></td>
