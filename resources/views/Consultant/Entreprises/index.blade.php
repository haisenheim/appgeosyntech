                  ...
                  <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form enctype="multipart/form-data" role="form" action="/consultant/entreprises/" method="post">
                        {{csrf_field()}}
                          <div class="card-body">
                            ...
                            <div class="form-group">
                              ...
                              <textarea style="height: 200px" name="description" id="description" class="form-control" cols="30" rows="10"></textarea>
                            </div>
